...
if (process.env.GMAIL_LIVE_TEST !== "1") {
  ...
  describe("standalone Gmail read smoke", () => {
    ...
    test("reads the named fixture through every read tool", async () => {
      ...
      expect(toolId(threadResult, "gmail_get_thread")).toBe(harness.fixture.threadId);
      ...
      expect(toolId(messageResult, "gmail_get_message")).toBe(harness.fixture.messageId);
